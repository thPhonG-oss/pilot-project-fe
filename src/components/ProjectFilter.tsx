...
export function ProjectFilter({ value, isLoading = false, onChange, onSearch, onReset }: ProjectFilterProps) {
    ...
    return (
        ...
        >
          ...
          <button
            className="h-8 bg-transparent px-2 text-sm text-sky-600 font-medium disabled:cursor-not-allowed disabled:opacity-60"
            type="button"
            disabled={isLoading}
            onClick={onReset}
          >
