  ...
  return (
    ...
    >
      <NavLink
        ...
        className={({ isActive }) =>
          `block whitespace-nowrap text-base font-semibold no-underline lg:mb-8 ${
      ...
      <span
        className={`block whitespace-nowrap text-base font-semibold no-underline lg:mb-4 text-sky-600`}
      >
        {t("nav.new")}
      </span>
      ...
      <span className="block whitespace-nowrap text-sm text-slate-500 lg:mb-3">
        {t("nav.customer")}
      </span>
      <span className="block whitespace-nowrap text-sm text-slate-500 lg:mb-3">
        {t("nav.supplier")}
