  ...
  return (
    <header className="flex h-[72px] items-center justify-between border-b border-slate-200 bg-white px-8 lg:px-[112px]">
      ...
      >
        ...
        <a className="text-sky-600 no-underline font-semibold" href="#help">
          {t("app.help")}
        </a>
        <button className="text-slate-400 font-semibold ml-6" type="button">
          {t("app.logout")}
        </button>
      </nav>
    </header>
